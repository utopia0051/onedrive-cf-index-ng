...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'utopia@aispeed.onmicrosoft.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/🌞 Public folder',
  ...
  footer:
    'Powered by <a href="https://www.utopian.pp.ua" target="_blank" rel="noopener noreferrer">遵纪守法小组</a>. Made with ❤ by Jason.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/🌞 Public folder', '/Demo/🌞 Public folder Password kfcv50'],
